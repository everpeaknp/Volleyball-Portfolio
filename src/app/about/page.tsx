  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        if (apiData) {
          const dynamicContent = mapAboutPageData(apiData, language)
          setT(dynamicContent)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-10 -left-10 w-2/3 rounded-2xl overflow-hidden shadow-xl border-4 border-white hidden md:block aspect-[4/3]">
                <Image
                  src={t.objectiveImage}
                  alt="Team huddled"
                  fill
                  className="object-cover"
                  unoptimized
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-base leading-relaxed">{t.vision.text}</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-base leading-relaxed">{t.mission.text}</p>
            </div>
          </div>
        </div>
      </section>
